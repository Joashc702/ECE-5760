//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="SIGNED" LPM_WIDTHA=15 LPM_WIDTHB=15 LPM_WIDTHP=30 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_9e01
	...
	wire	[15:0]	wire_sum_adder1aa_5dataa;
	wire	[15:0]	wire_sum_adder1aa_5datab;
	wire	[15:0]	wire_sum_adder1aa_5result;
	wire	[15:0]	wire_sum_adder1aa_6dataa;
	wire	[15:0]	wire_sum_adder1aa_6datab;
	wire	[15:0]	wire_sum_adder1aa_6result;
	...
	wire  [6:0]   wire_sft18a_in;
	wire  [6:0]   wire_sft18a_out;
	wire  [6:0]   wire_sft19a_in;
	wire  [6:0]   wire_sft19a_out;
	wire  [6:0]   wire_sft20a_in;
	wire  [6:0]   wire_sft20a_out;
	...
	wire  w396w;
	wire  [30:0]  w694w;
	wire  [224:0]  w_decoder_node9w;
	wire  [14:0]  w_le_datab_node8w;
	wire  [14:0]  w_lone_sum_node11w;
	wire  [118:0]  w_sum_node10w;
	...
	assign
		wire_sum_adder1aa_5dataa = {w_decoder_node9w[179], w_decoder_node9w[179:165]},
		wire_sum_adder1aa_5datab = {{2{w_decoder_node9w[164]}}, w_decoder_node9w[164:151]};
	assign
		wire_sum_adder1aa_6result = wire_sum_adder1aa_6dataa + wire_sum_adder1aa_6datab;
	assign
		wire_sum_adder1aa_6dataa = {w_decoder_node9w[209], w_decoder_node9w[209:195]},
		wire_sum_adder1aa_6datab = {{2{w_decoder_node9w[194]}}, w_decoder_node9w[194:181]};
	soft   sft10a_0
	( 
	...
	assign
		wire_sft10a_in = {w396w, {w396w, {w396w, {w396w, {w396w, {(~ w_sum_node10w[84]), {w380w, {(~ w_lone_sum_node11w[8]), {(~ w_lone_sum_node11w[7]), {w_sum_node10w[110], {w_sum_node10w[109], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {2{w396w}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w396w, {w_sum_node10w[83], {(~ w_sum_node10w[67]), {w380w, {(~ w_lone_sum_node11w[6]), {(~ w_lone_sum_node11w[5]), {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86:85]}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w396w, {w396w, {w396w, {w_sum_node10w[81], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29], {w_sum_node10w[28], {w_sum_node10w[27], {w_sum_node10w[26:25]}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w396w, {w396w, {w396w, {w396w, {(~ w_sum_node10w[50]), {w380w, {(~ w_lone_sum_node11w[4]), {(~ w_lone_sum_node11w[3]), {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {2{w396w}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft18a_in = {w396w, {w_sum_node10w[49], {(~ w_sum_node10w[33]), {w380w, {(~ w_lone_sum_node11w[2]), {(~ w_lone_sum_node11w[1]), (~ w_lone_sum_node11w[0])}}}}}};
	soft   sft19a_0
	( 
	...
	assign
		wire_sft19a_in = {w396w, {w396w, {w396w, {w_sum_node10w[32], {(~ w_sum_node10w[16]), {w_sum_node10w[15:14]}}}}}};
	soft   sft20a_0
	( 
	...
	assign
		wire_sft20a_in = {w396w, {w396w, {w396w, {w396w, {w380w, {w396w, w380w}}}}}};
	soft   sft21a_0
	( 
	...
	assign
		wire_sft3a_in = {w380w, {wire_sft11a_out[23], {w380w, {w380w, {(~ w_lone_sum_node11w[12]), {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[82], {w_sum_node10w[66], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {w_sum_node10w[13], {w_sum_node10w[12], {w_sum_node10w[11], {w_sum_node10w[10], {w_sum_node10w[9], {w_sum_node10w[8], {w_sum_node10w[7], {w_sum_node10w[6], {w_sum_node10w[5], {w_sum_node10w[4], {w_sum_node10w[3:2]}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft4a_0
	( 
	...
	assign
		wire_sft4a_in = {w396w, {w396w, {w_lone_sum_node11w[14], {(~ w_lone_sum_node11w[13]), {w_sum_node10w[116], {w_sum_node10w[115], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft16a_out[10], {wire_sft16a_out[9], {wire_sft16a_out[8], {wire_sft16a_out[7], {wire_sft16a_out[6], {wire_sft16a_out[5], {wire_sft16a_out[4], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21], {w_sum_node10w[20], {w_sum_node10w[19], {w_sum_node10w[18:17]}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft5a_in = {w396w, {w396w, {wire_sft11a_out[22], {wire_sft11a_out[21], {wire_sft11a_out[20], {wire_sft11a_out[19], {wire_sft16a_out[14], {wire_sft16a_out[13], {wire_sft16a_out[12], {wire_sft16a_out[11], {wire_sft21a_out[6], {wire_sft21a_out[5], {wire_sft21a_out[4], {wire_sft21a_out[3], {wire_sft21a_out[2], {wire_sft21a_out[1], {wire_sft21a_out[0], {wire_sft16a_out[3], {wire_sft16a_out[2], {wire_sft16a_out[1], {wire_sft16a_out[0], {wire_sft11a_out[3], {wire_sft11a_out[2], {wire_sft11a_out[1], {wire_sft11a_out[0], {w_sum_node10w[35], {w_sum_node10w[34], {2{w396w}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft6a_0
	( 
	...
	assign
		wire_sft8a_in = {w396w, {(~ w_sum_node10w[118]), {w_sum_node10w[117], {(~ w_sum_node10w[101]), {w380w, {(~ w_lone_sum_node11w[10]), {(~ w_lone_sum_node11w[9]), {w_sum_node10w[112], {w_sum_node10w[111], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[61], {w_sum_node10w[60], {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52:51]}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w396w, {w396w, {w396w, {w396w, {(~ w_lone_sum_node11w[11]), {w_sum_node10w[114], {w_sum_node10w[113], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43], {w_sum_node10w[42], {w_sum_node10w[41], {w_sum_node10w[40], {w_sum_node10w[39], {w_sum_node10w[38], {w_sum_node10w[37:36]}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[14:0]},
		datab_node = {datab[14:0]},
		final_result_node = {w694w[29:0]},
		result = {final_result_node[29:0]},
		w380w = 1'b1,
		w396w = 1'b0,
		w694w = {wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[14:0]} & {15{w_le_datab_node8w[14]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[13]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[12]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[11]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[10]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[9]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[8]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[7]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[6]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[5]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[4]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[3]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[2]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[1]}}), ({dataa_node[14:0]} & {15{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[14:0]},
		w_lone_sum_node11w = {w_decoder_node9w[224:210]},
		w_sum_node10w = {wire_sum_adder1aa_6result[15:0], w_decoder_node9w[180], wire_sum_adder1aa_5result[15:0], w_decoder_node9w[150], wire_sum_adder1aa_4result[15:0], w_decoder_node9w[120], wire_sum_adder1aa_3result[15:0], w_decoder_node9w[90], wire_sum_adder1aa_2result[15:0], w_decoder_node9w[60], wire_sum_adder1aa_1result[15:0], w_decoder_node9w[30], wire_sum_adder1aa_0result[15:0], w_decoder_node9w[0]};
endmodule //mult_9e01
//VALID FILE
