	Computer_System u0 (
		...
		.card_eight_external_connection_export       (<connected-to-card_eight_external_connection_export>),       //       card_eight_external_connection.export
		.card_five_external_connection_export        (<connected-to-card_five_external_connection_export>),        //        card_five_external_connection.export
		.card_four_external_connection_export        (<connected-to-card_four_external_connection_export>),        //        card_four_external_connection.export
		.card_nine_external_connection_export        (<connected-to-card_nine_external_connection_export>),        //        card_nine_external_connection.export
		.card_one_external_connection_export         (<connected-to-card_one_external_connection_export>),         //         card_one_external_connection.export
		.card_seven_external_connection_export       (<connected-to-card_seven_external_connection_export>),       //       card_seven_external_connection.export
		.card_six_external_connection_export         (<connected-to-card_six_external_connection_export>),         //         card_six_external_connection.export
		...
		.num_ties_external_connection_export         (<connected-to-num_ties_external_connection_export>),         //         num_ties_external_connection.export
		.num_wins_external_connection_export         (<connected-to-num_wins_external_connection_export>),         //         num_wins_external_connection.export
		.onchip_sram_cards_s1_address                (<connected-to-onchip_sram_cards_s1_address>),                //                 onchip_sram_cards_s1.address
		.onchip_sram_cards_s1_clken                  (<connected-to-onchip_sram_cards_s1_clken>),                  //                                     .clken
		.onchip_sram_cards_s1_chipselect             (<connected-to-onchip_sram_cards_s1_chipselect>),             //                                     .chipselect
		.onchip_sram_cards_s1_write                  (<connected-to-onchip_sram_cards_s1_write>),                  //                                     .write
		.onchip_sram_cards_s1_readdata               (<connected-to-onchip_sram_cards_s1_readdata>),               //                                     .readdata
		.onchip_sram_cards_s1_writedata              (<connected-to-onchip_sram_cards_s1_writedata>),              //                                     .writedata
		.onchip_sram_cards_s1_byteenable             (<connected-to-onchip_sram_cards_s1_byteenable>),             //                                     .byteenable
		.onchip_sram_seed_s1_address                 (<connected-to-onchip_sram_seed_s1_address>),                 //                  onchip_sram_seed_s1.address
		.onchip_sram_seed_s1_clken                   (<connected-to-onchip_sram_seed_s1_clken>),                   //                                     .clken
		.onchip_sram_seed_s1_chipselect              (<connected-to-onchip_sram_seed_s1_chipselect>),              //                                     .chipselect
		.onchip_sram_seed_s1_write                   (<connected-to-onchip_sram_seed_s1_write>),                   //                                     .write
		.onchip_sram_seed_s1_readdata                (<connected-to-onchip_sram_seed_s1_readdata>),                //                                     .readdata
		.onchip_sram_seed_s1_writedata               (<connected-to-onchip_sram_seed_s1_writedata>),               //                                     .writedata
		.onchip_sram_seed_s1_byteenable              (<connected-to-onchip_sram_seed_s1_byteenable>),              //                                     .byteenable
