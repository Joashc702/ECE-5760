...
module Computer_System_mm_interconnect_0 (
		...
		input  wire         Onchip_SRAM_reset2_reset_bridge_in_reset_reset,                        //                        Onchip_SRAM_reset2_reset_bridge_in_reset.reset
	...
	wire   [29:0] onchip_memory_seed_s2_agent_m0_address;                     // onchip_memory_seed_s2_agent:m0_address -> onchip_memory_seed_s2_translator:uav_address
	...
	wire  [125:0] onchip_memory_seed_s2_agent_rf_source_data;                 // onchip_memory_seed_s2_agent:rf_source_data -> onchip_memory_seed_s2_agent_rsp_fifo:in_data
	...
	wire  [125:0] onchip_memory_seed_s2_agent_rsp_fifo_out_data;              // onchip_memory_seed_s2_agent_rsp_fifo:out_data -> onchip_memory_seed_s2_agent:rf_sink_data
	...
	wire          onchip_sram_s2_agent_rp_valid;                              // Onchip_SRAM_s2_agent:rp_valid -> router_002:sink_valid
	wire  [124:0] onchip_sram_s2_agent_rp_data;                               // Onchip_SRAM_s2_agent:rp_data -> router_002:sink_data
	wire          onchip_sram_s2_agent_rp_ready;                              // router_002:sink_ready -> Onchip_SRAM_s2_agent:rp_ready
	wire          onchip_sram_s2_agent_rp_startofpacket;                      // Onchip_SRAM_s2_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          onchip_sram_s2_agent_rp_endofpacket;                        // Onchip_SRAM_s2_agent:rp_endofpacket -> router_002:sink_endofpacket
	wire          onchip_memory_seed_s2_agent_rp_valid;                       // onchip_memory_seed_s2_agent:rp_valid -> router_003:sink_valid
	wire  [124:0] onchip_memory_seed_s2_agent_rp_data;                        // onchip_memory_seed_s2_agent:rp_data -> router_003:sink_data
	wire          onchip_memory_seed_s2_agent_rp_ready;                       // router_003:sink_ready -> onchip_memory_seed_s2_agent:rp_ready
	wire          onchip_memory_seed_s2_agent_rp_startofpacket;               // onchip_memory_seed_s2_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          onchip_memory_seed_s2_agent_rp_endofpacket;                 // onchip_memory_seed_s2_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [124:0] onchip_memory_seed_s2_burst_adapter_source0_data;           // onchip_memory_seed_s2_burst_adapter:source0_data -> onchip_memory_seed_s2_agent:cp_data
	...
	wire    [1:0] onchip_memory_seed_s2_burst_adapter_source0_channel;        // onchip_memory_seed_s2_burst_adapter:source0_channel -> onchip_memory_seed_s2_agent:cp_channel
	...
	wire          router_002_src_valid;                                       // router_002:src_valid -> Onchip_SRAM_s2_rsp_width_adapter:in_valid
	wire  [124:0] router_002_src_data;                                        // router_002:src_data -> Onchip_SRAM_s2_rsp_width_adapter:in_data
	wire          router_002_src_ready;                                       // Onchip_SRAM_s2_rsp_width_adapter:in_ready -> router_002:src_ready
	wire    [1:0] router_002_src_channel;                                     // router_002:src_channel -> Onchip_SRAM_s2_rsp_width_adapter:in_channel
	wire          router_002_src_startofpacket;                               // router_002:src_startofpacket -> Onchip_SRAM_s2_rsp_width_adapter:in_startofpacket
	wire          router_002_src_endofpacket;                                 // router_002:src_endofpacket -> Onchip_SRAM_s2_rsp_width_adapter:in_endofpacket
	wire          onchip_sram_s2_rsp_width_adapter_src_valid;                 // Onchip_SRAM_s2_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [232:0] onchip_sram_s2_rsp_width_adapter_src_data;                  // Onchip_SRAM_s2_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          onchip_sram_s2_rsp_width_adapter_src_ready;                 // rsp_demux:sink_ready -> Onchip_SRAM_s2_rsp_width_adapter:out_ready
	wire    [1:0] onchip_sram_s2_rsp_width_adapter_src_channel;               // Onchip_SRAM_s2_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	...
	wire          router_003_src_valid;                                       // router_003:src_valid -> onchip_memory_seed_s2_rsp_width_adapter:in_valid
	wire  [124:0] router_003_src_data;                                        // router_003:src_data -> onchip_memory_seed_s2_rsp_width_adapter:in_data
	wire          router_003_src_ready;                                       // onchip_memory_seed_s2_rsp_width_adapter:in_ready -> router_003:src_ready
	wire    [1:0] router_003_src_channel;                                     // router_003:src_channel -> onchip_memory_seed_s2_rsp_width_adapter:in_channel
	wire          router_003_src_startofpacket;                               // router_003:src_startofpacket -> onchip_memory_seed_s2_rsp_width_adapter:in_startofpacket
	wire          router_003_src_endofpacket;                                 // router_003:src_endofpacket -> onchip_memory_seed_s2_rsp_width_adapter:in_endofpacket
	wire          onchip_memory_seed_s2_rsp_width_adapter_src_valid;          // onchip_memory_seed_s2_rsp_width_adapter:out_valid -> rsp_demux_001:sink_valid
	wire  [232:0] onchip_memory_seed_s2_rsp_width_adapter_src_data;           // onchip_memory_seed_s2_rsp_width_adapter:out_data -> rsp_demux_001:sink_data
	wire          onchip_memory_seed_s2_rsp_width_adapter_src_ready;          // rsp_demux_001:sink_ready -> onchip_memory_seed_s2_rsp_width_adapter:out_ready
	wire    [1:0] onchip_memory_seed_s2_rsp_width_adapter_src_channel;        // onchip_memory_seed_s2_rsp_width_adapter:out_channel -> rsp_demux_001:sink_channel
	wire          onchip_memory_seed_s2_rsp_width_adapter_src_startofpacket;  // onchip_memory_seed_s2_rsp_width_adapter:out_startofpacket -> rsp_demux_001:sink_startofpacket
	wire          onchip_memory_seed_s2_rsp_width_adapter_src_endofpacket;    // onchip_memory_seed_s2_rsp_width_adapter:out_endofpacket -> rsp_demux_001:sink_endofpacket
	wire          cmd_mux_src_valid;                                          // cmd_mux:src_valid -> Onchip_SRAM_s2_cmd_width_adapter:in_valid
	wire  [232:0] cmd_mux_src_data;                                           // cmd_mux:src_data -> Onchip_SRAM_s2_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                          // Onchip_SRAM_s2_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                        // cmd_mux:src_channel -> Onchip_SRAM_s2_cmd_width_adapter:in_channel
	...
	wire          cmd_mux_001_src_valid;                                      // cmd_mux_001:src_valid -> onchip_memory_seed_s2_cmd_width_adapter:in_valid
	wire  [232:0] cmd_mux_001_src_data;                                       // cmd_mux_001:src_data -> onchip_memory_seed_s2_cmd_width_adapter:in_data
	wire          cmd_mux_001_src_ready;                                      // onchip_memory_seed_s2_cmd_width_adapter:in_ready -> cmd_mux_001:src_ready
	wire    [1:0] cmd_mux_001_src_channel;                                    // cmd_mux_001:src_channel -> onchip_memory_seed_s2_cmd_width_adapter:in_channel
	wire          cmd_mux_001_src_startofpacket;                              // cmd_mux_001:src_startofpacket -> onchip_memory_seed_s2_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_001_src_endofpacket;                                // cmd_mux_001:src_endofpacket -> onchip_memory_seed_s2_cmd_width_adapter:in_endofpacket
	wire          onchip_memory_seed_s2_cmd_width_adapter_src_valid;          // onchip_memory_seed_s2_cmd_width_adapter:out_valid -> onchip_memory_seed_s2_burst_adapter:sink0_valid
	wire  [124:0] onchip_memory_seed_s2_cmd_width_adapter_src_data;           // onchip_memory_seed_s2_cmd_width_adapter:out_data -> onchip_memory_seed_s2_burst_adapter:sink0_data
	wire          onchip_memory_seed_s2_cmd_width_adapter_src_ready;          // onchip_memory_seed_s2_burst_adapter:sink0_ready -> onchip_memory_seed_s2_cmd_width_adapter:out_ready
	wire    [1:0] onchip_memory_seed_s2_cmd_width_adapter_src_channel;        // onchip_memory_seed_s2_cmd_width_adapter:out_channel -> onchip_memory_seed_s2_burst_adapter:sink0_channel
	wire          onchip_memory_seed_s2_cmd_width_adapter_src_startofpacket;  // onchip_memory_seed_s2_cmd_width_adapter:out_startofpacket -> onchip_memory_seed_s2_burst_adapter:sink0_startofpacket
	wire          onchip_memory_seed_s2_cmd_width_adapter_src_endofpacket;    // onchip_memory_seed_s2_cmd_width_adapter:out_endofpacket -> onchip_memory_seed_s2_burst_adapter:sink0_endofpacket
	...
	wire          onchip_sram_s2_agent_rdata_fifo_out_valid;                  // Onchip_SRAM_s2_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] onchip_sram_s2_agent_rdata_fifo_out_data;                   // Onchip_SRAM_s2_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire          onchip_sram_s2_agent_rdata_fifo_out_ready;                  // avalon_st_adapter:in_0_ready -> Onchip_SRAM_s2_agent_rdata_fifo:out_ready
	...
	wire          onchip_memory_seed_s2_agent_rdata_fifo_out_valid;           // onchip_memory_seed_s2_agent_rdata_fifo:out_valid -> avalon_st_adapter_001:in_0_valid
	wire   [33:0] onchip_memory_seed_s2_agent_rdata_fifo_out_data;            // onchip_memory_seed_s2_agent_rdata_fifo:out_data -> avalon_st_adapter_001:in_0_data
	wire          onchip_memory_seed_s2_agent_rdata_fifo_out_ready;           // avalon_st_adapter_001:in_0_ready -> onchip_memory_seed_s2_agent_rdata_fifo:out_ready
	wire          avalon_st_adapter_001_out_0_valid;                          // avalon_st_adapter_001:out_0_valid -> onchip_memory_seed_s2_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_001_out_0_data;                           // avalon_st_adapter_001:out_0_data -> onchip_memory_seed_s2_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_001_out_0_ready;                          // onchip_memory_seed_s2_agent:rdata_fifo_sink_ready -> avalon_st_adapter_001:out_0_ready
	wire    [0:0] avalon_st_adapter_001_out_0_error;                          // avalon_st_adapter_001:out_0_error -> onchip_memory_seed_s2_agent:rdata_fifo_sink_error
	...
	altera_merlin_slave_translator #(
		...
		.reset                  (Onchip_SRAM_reset2_reset_bridge_in_reset_reset), //                    reset.reset
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (System_PLL_sys_clk_clk),                             //             clk.clk
		.reset                   (Onchip_SRAM_reset2_reset_bridge_in_reset_reset),     //       clk_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.reset                 (Onchip_SRAM_reset2_reset_bridge_in_reset_reset),     // cr0_reset.reset
	...
	altera_merlin_burst_adapter #(
		...
		.clk                   (System_PLL_sys_clk_clk),                                    //       cr0.clk
		.reset                 (Onchip_SRAM_reset2_reset_bridge_in_reset_reset),            // cr0_reset.reset
		.sink0_valid           (onchip_memory_seed_s2_cmd_width_adapter_src_valid),         //     sink0.valid
		.sink0_data            (onchip_memory_seed_s2_cmd_width_adapter_src_data),          //          .data
		.sink0_channel         (onchip_memory_seed_s2_cmd_width_adapter_src_channel),       //          .channel
		.sink0_startofpacket   (onchip_memory_seed_s2_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.sink0_endofpacket     (onchip_memory_seed_s2_cmd_width_adapter_src_endofpacket),   //          .endofpacket
		.sink0_ready           (onchip_memory_seed_s2_cmd_width_adapter_src_ready),         //          .ready
	...
	Computer_System_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (System_PLL_sys_clk_clk),                                    //       clk.clk
		.reset              (Onchip_SRAM_reset2_reset_bridge_in_reset_reset),            // clk_reset.reset
		.sink_ready         (onchip_memory_seed_s2_rsp_width_adapter_src_ready),         //      sink.ready
		.sink_channel       (onchip_memory_seed_s2_rsp_width_adapter_src_channel),       //          .channel
		.sink_data          (onchip_memory_seed_s2_rsp_width_adapter_src_data),          //          .data
		.sink_startofpacket (onchip_memory_seed_s2_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.sink_endofpacket   (onchip_memory_seed_s2_rsp_width_adapter_src_endofpacket),   //          .endofpacket
		.sink_valid         (onchip_memory_seed_s2_rsp_width_adapter_src_valid),         //          .valid
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (1),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) onchip_memory_seed_s2_rsp_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                    //       clk.clk
		.reset                (Onchip_SRAM_reset2_reset_bridge_in_reset_reset),            // clk_reset.reset
		...
		.out_endofpacket      (onchip_memory_seed_s2_rsp_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (onchip_memory_seed_s2_rsp_width_adapter_src_data),          //          .data
		.out_channel          (onchip_memory_seed_s2_rsp_width_adapter_src_channel),       //          .channel
		.out_valid            (onchip_memory_seed_s2_rsp_width_adapter_src_valid),         //          .valid
		.out_ready            (onchip_memory_seed_s2_rsp_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (onchip_memory_seed_s2_rsp_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                     // (terminated)
	);
	...
	altera_merlin_width_adapter #(
		...
		.PACKING                       (0),
		.ENABLE_ADDRESS_ALIGNMENT      (1)
	) onchip_memory_seed_s2_cmd_width_adapter (
		.clk                  (System_PLL_sys_clk_clk),                                    //       clk.clk
		.reset                (Onchip_SRAM_reset2_reset_bridge_in_reset_reset),            // clk_reset.reset
		...
		.out_endofpacket      (onchip_memory_seed_s2_cmd_width_adapter_src_endofpacket),   //       src.endofpacket
		.out_data             (onchip_memory_seed_s2_cmd_width_adapter_src_data),          //          .data
		.out_channel          (onchip_memory_seed_s2_cmd_width_adapter_src_channel),       //          .channel
		.out_valid            (onchip_memory_seed_s2_cmd_width_adapter_src_valid),         //          .valid
		.out_ready            (onchip_memory_seed_s2_cmd_width_adapter_src_ready),         //          .ready
		.out_startofpacket    (onchip_memory_seed_s2_cmd_width_adapter_src_startofpacket), //          .startofpacket
		.in_command_size_data (3'b000)                                                     // (terminated)
	);
	...
	Computer_System_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (Onchip_SRAM_reset2_reset_bridge_in_reset_reset), // in_rst_0.reset
