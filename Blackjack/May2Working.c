...
#define NUM_SIMUL 2 //should be 5, 10, 15
...
void display_card(int, char[], char[], int);
...
void playBlackjack(int* playerChips, int numberOfPlayers) {
    ...
    for (int i = 0; i < numberOfPlayers; i++) {
        ...
        printf(curr_card);
        display_card(i, curr_card, deck[deckPosition - 1].suit, num_cards_players[i]);
        num_cards_players[i]++;
...
void display_card(int player, char value[], char suit[], int ind){
    int box_width = 30;
    int box_height = 45;
    int card_spacing_x = 16;  
    int card_spacing_y = 16;  
...
void graphics_main(){
  ...
  */
  ...
  VGA_text(26,56,"$100");
  VGA_disc(264, 452, 15, green);
  VGA_text(32,56,"$50");
  VGA_disc(304, 452, 15, dark_green); // orange
  VGA_text(37,56,"$20");
  VGA_disc(344, 452, 15, dark_green); // yellow
  VGA_text(42,56,"$10");
  VGA_disc(384, 452, 15, dark_green); // purple
  VGA_text(47,56,"$5");
  ...
  VGA_disc(180,175,25,dark_green); // brown
  VGA_text(21,21,"HIT");
  VGA_line(210, 150, 210, 200, red);
  VGA_box(210, 150, 300, 200, colors[9]); //gray
  VGA_text(28,19,"Hit Prob");
  
  VGA_disc(380,175,25,dark_green); // brown
  VGA_text(45,21,"STAND");
  VGA_line(410, 150, 410, 200, red);
  VGA_box(410, 150, 500, 200, colors[9]); // gray
  VGA_text(52,19,"Stand Prob");
